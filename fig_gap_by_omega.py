...
# -*- coding: utf-8 -*-
"""
Build the honest by-omega gap heatmap for S10: row-normalised gap distribution,
only strata with >= 10^4 gaps (omega 1..6), sample sizes annotated, omega>=7
omitted (noise-dominated). Reads ../data/gap_hist_byomega_S10.csv.
"""
import csv, math
...
GMAX=50
# only strata with adequate sample (>=10000): here omega 1..6
...
# annotate the key gaps (only those with a real signal: 30,42,210)
for g,lab,col in [(5,'6dN=30','#33d6ff'),(7,'6dN=42','#7CFC00'),(35,'6dN=210','#ffffff')]:
...
print("heatmap saved; omegas used:",omegas)
